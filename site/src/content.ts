...
export const docPages: ArticlePage[] = [
  {
    ...
    sections: [
      ...
      },
      {
        id: 'minimal',
        title: '最小示例',
        body: ['安装后先初始化项目，再对生成的 `tcases` 目录执行检查和运行。'],
        code: {
          title: '安装与初始化',
          language: 'bash',
    ...
    sections: [
      ...
      },
      {
        ...
        code: {
          ...
          language: 'text',
          code: `优化前:
FAIL: tcases/tc_demo.yaml -> Failed to load tcases/tc_demo.yaml
steps.0.request.url
    ...
    path: /api/users`,
      ...
      },
      {
        ...
        code: {
          ...
          language: 'text',
          code: `优化前:
FAIL: tcases/tc_users.yaml -> Invalid top-level 'parameters'.
