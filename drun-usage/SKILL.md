---
name: drun-usage
description: 面向 drun 深度使用与实战生成的跨 Agent skill，适用于 pi、Codex、Claude Code 等编码代理。当用户提到 drun 用例、drun YAML、drun run、drun check、drun q、drun invoke、drun convert、drun export curl、drun 报告、drun 排障，或要求编写/解释/调试 drun YAML 与命令时触发。默认中文，优先给可运行 YAML、CLI 命令和修正建议。
---
