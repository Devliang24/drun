...
4. 优先使用当前仓库已支持的能力：`invoke_case_name`、`invoke_case_names`、`sleep`、`repeat`、`request.files`、`request.auth`、`request.stream`、`response.save_body_to`、`export.csv`、`-persist-env`、`-secrets`、`-snippet`、`convert`、`export curl`、`server`。
